...
export const AppSidebar = memo(function AppSidebar({ studioId }: AppSidebarProps) {
  ...
  const isStudioAdmin = user?.role === "MASTER" || hasMinRole("ADMINISTRADOR");
        ...
        <SidebarGroup className="mt-4">
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              {(isStudioAdmin || user?.role === "MASTER") && (
                <SidebarMenuItem>
                  <SidebarMenuButton
                    asChild
                  ...
                  >
                    <Link href="/admin" className="flex items-center gap-2.5 px-2" data-testid="link-admin">
