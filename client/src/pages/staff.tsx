              ...
              <div className="space-y-4 py-2">
                ...
                <FieldGroup label={pt.staff.role}>
                  <Select value={role} onValueChange={setRole}>
                    ...
                    <SelectContent>
                      <SelectItem value="DUBLADOR">{pt.studio.roles.DUBLADOR}</SelectItem>
                      <SelectItem value="DIRETOR">{pt.studio.roles.DIRETOR}</SelectItem>
                      <SelectItem value="ALUNO">{pt.studio.roles.ALUNO}</SelectItem>
                    </SelectContent>
                  </Select>
                </FieldGroup>
              </div>
