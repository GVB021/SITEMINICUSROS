...
const STUDIO_ROLES = [
  { value: "ADMINISTRADOR", label: pt.studio.roles.ADMINISTRADOR },
  { value: "DIRETOR", label: pt.studio.roles.DIRETOR },
  { value: "DUBLADOR", label: pt.studio.roles.DUBLADOR },
  { value: "ALUNO", label: pt.studio.roles.ALUNO },
];
