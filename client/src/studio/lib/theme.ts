export const theme = {
  colors: {
    ...
    accent: {
      blue:       "hsl(221 83% 53%)",
      blueFaint:  "hsl(221 83% 53% / 0.08)",
      blueSubtle: "hsl(221 83% 53% / 0.15)",
      blueBorder: "hsl(221 83% 53% / 0.25)",
    ...
    status: {
      ...
      completed: { bg: "bg-blue-500/12",     text: "text-blue-400",    ring: "border-blue-500/25"    },
    ...
    roles: {
      ...
      director:       "bg-blue-500/12 text-blue-400 border-blue-500/25",
      diretor:        "bg-blue-500/12 text-blue-400 border-blue-500/25",
      engineer:       "bg-blue-500/12 text-blue-400 border-blue-500/25",
      engenheiro_audio: "bg-blue-500/12 text-blue-400 border-blue-500/25",
