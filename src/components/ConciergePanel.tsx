...
export default function ConciergePanel({
  data, config, itinerary, onAddItem, onRemoveItem, onBack, onReoptimize, onChangeKey,
}: Props) {
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="btn-ghost" onClick={onChangeKey} style={{ fontSize: 12, padding: '6px 12px' }}>
            🔑 API
          </button>
          <button
